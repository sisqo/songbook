...
Songbook — a private, invite-only PWA for reading a musician's own lyrics/chords on stage:
...
Deployed on Vercel (`sisqo` account), production at https://songbook.sisqo.dev. Full product

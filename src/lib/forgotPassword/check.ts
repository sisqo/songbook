/**
 * The read-only half of `/reimposta-password` (v3.2, PLAN.md point 6) — whether a reset
 ...
 * recheck, since neither call sits inside an explicit transaction, unlike `/verifica`'s
 ...
 * takes, so `/reimposta-password` shows the form directly rather than a button first (see

 ...
 *
 * English, like the rest of the code and like both maps it is spread into. The README is
 * the Italian half of this project; the strings the code ships are not.
 */

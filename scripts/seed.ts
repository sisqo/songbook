...
/** Songs referenced by a setlist but with no file of their own. */
...
for (const setlist of setlistFiles) {
  ...
  // Rewritten wholesale: order is the point of a setlist, and diffing positions
  // would be more code than replacing them.
